# Awesome WPO [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 435,650 | 🐛 67 | 📅 2026-01-28 with stars

[![GitHub contributors](https://img.shields.io/github/contributors/davidsonfellipe/awesome-wpo.svg)](https://github.com/davidsonfellipe/awesome-wpo/graphs/contributors) ⭐ 8,799 | 🐛 5 | 🌐 JavaScript | 📅 2025-07-21
...
* [Lighthouse](https://github.com/GoogleChrome/lighthouse) ⭐ 29,784 | 🐛 503 | 🌐 JavaScript | 📅 2026-02-06 - Auditing and performance metrics tool for Progressive Web Applications.
...
* [Yandex.Tank](https://github.com/yandex/yandex-tank) ⭐ 2,567 | 🐛 84 | 🌐 Python | 📅 2026-02-03 - An extensible open-source load testing tool for advanced Linux users which is especially good as a part of an automated load testing suite.
...
* [PSI](https://github.com/addyosmani/psi) ⭐ 3,114 | 🐛 15 | 🌐 JavaScript | 📅 2021-04-10 - PageSpeed Insights for Node.js - with reporting.
...
* [Webpack bundle analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) ⭐ 12,685 | 🐛 24 | 🌐 JavaScript | 📅 2026-02-06 - webpack plugin and CLI utility that represents bundle content as a convenient interactive zoomable treemap.
...
* [Compression webpack plugin](https://github.com/webpack-contrib/compression-webpack-plugin) ⭐ 1,426 | 🐛 5 | 🌐 JavaScript | 📅 2026-01-22 - Prepare compressed versions of assets to serve them with Content-Encoding.
* [BundleStats](https://github.com/relative-ci/bundle-stats) ⭐ 667 | 🐛 57 | 🌐 TypeScript | 📅 2026-02-06 - Generate bundle report(bundle size, assets, modules, packages) and compare the results between different builds
...
* [Stats.js](https://github.com/mrdoob/stats.js) ⭐ 9,094 | 🐛 22 | 🌐 JavaScript | 📅 2024-10-11 - This class provides a simple info box that will help you monitor your code performance.
...
* [jsDelivr](https://github.com/jsdelivr/jsdelivr) ⭐ 6,149 | 🐛 73 | 🌐 JavaScript | 📅 2025-04-02 - Similar to Google Hosted Libraries, jsDelivr is an open-source CDN that allows developers to host their own projects and anyone to link to our hosted files on their sites.
...
* [Assetgraph-sprite](https://github.com/assetgraph/assetgraph-sprite) ⭐ 36 | 🐛 9 | 🌐 JavaScript | 📅 2026-01-22 - Assetgraph transform for auto-generating sprites based on the CSS dependency graph.
...
* [Sharp](https://github.com/lovell/sharp) ⭐ 31,865 | 🐛 116 | 🌐 JavaScript | 📅 2026-02-01 - The typical use case for this high-speed Node.js module is to convert large images of many formats to smaller, web-friendly JPEG, PNG, and WebP images of varying dimensions.
* [Exexif](https://github.com/h4cc/awesome-elixir) ⭐ 13,080 | 🐛 7 | 🌐 Elixir | 📅 2025-10-12 - Pure elixir library to extract tiff and exif metadata from JPEG files.
* [Gm](https://github.com/aheckmann/gm) ⭐ 6,982 | 🐛 368 | 🌐 JavaScript | 📅 2025-02-25 - GraphicsMagick and ImageMagick for Node.js.
...
* [Jpegoptim](https://github.com/tjko/jpegoptim) ⭐ 1,760 | 🐛 12 | 🌐 C | 📅 2026-02-01 - Utility to optimize/compress JPEG files.
* [Grunt-contrib-imagemin](https://github.com/gruntjs/grunt-contrib-imagemin) ⭐ 1,213 | 🐛 8 | 🌐 JavaScript | 📅 2024-07-02 - Minify PNG and JPEG images for Grunt.
...
* [lozad.js](https://github.com/ApoorvSaxena/lozad.js) ⭐ 7,508 | 🐛 69 | 🌐 JavaScript | 📅 2025-11-18 - Highly performant, light \~0.9kb, and configurable lazy loader in pure JS with no dependencies for responsive images, iframes, and more
...
* [Phantomas](https://github.com/macbre/phantomas) ⭐ 2,265 | 🐛 62 | 🌐 JavaScript | 📅 2026-02-05 - PhantomJS-based web performance metrics collector and monitoring tool.
...
* [UglifyJS2](https://github.com/mishoo/UglifyJS2) ⭐ 13,396 | 🐛 44 | 🌐 JavaScript | 📅 2024-11-22 - UglifyJS is a JavaScript parser, minifier, compressor or beautifier toolkit, written in JavaScript.
* [Clean-css](https://github.com/jakubpawlowicz/clean-css) ⭐ 4,205 | 🐛 42 | 🌐 JavaScript | 📅 2024-10-18 - A fast, efficient, and well-tested CSS minifier for node.js.
...
* [CSSO](https://github.com/css/csso) ⭐ 3,796 | 🐛 104 | 🌐 JavaScript | 📅 2024-06-21 - CSS minimizer unlike others. In addition to usual minification techniques, it can perform structural optimization of CSS files, resulting in smaller file size compared to other minifiers.
...
* [SVGO](https://github.com/svg/svgo) ⭐ 22,293 | 🐛 260 | 🌐 JavaScript | 📅 2026-01-01 - SVGO is a Nodejs-based tool for optimizing SVG vector graphics files.
...
* [Polymer Bundler](https://github.com/Polymer/tools/tree/master/packages/bundler) ⭐ 436 | 🐛 841 | 🌐 TypeScript | 📅 2026-01-24 - Polymer-bundler is a library for packaging project assets for production to minimize network round-trips.
...
* [wrk](https://github.com/wg/wrk) ⭐ 40,045 | 🐛 202 | 🌐 C | 📅 2023-12-30 - A HTTP benchmarking tool (with optional Lua scripting for request generation, response
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 435,650 | 🐛 67 | 📅 2026-01-28.
* [bayandin/awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,201 | 🐛 43 | 🌐 Ruby | 📅 2024-06-02.
* [imteekay/web-performance-research](https://github.com/imteekay/web-performance-research) ⭐ 1,034 | 🐛 0 | 🌐 JavaScript | 📅 2025-11-07 - Research in Web Performance
...
For contributing, [open an issue](https://github.com/davidsonfellipe/awesome-wpo/issues) ⭐ 8,799 | 🐛 5 | 🌐 JavaScript | 📅 2025-07-21 and/or a [pull request](https://github.com/davidsonfellipe/awesome-wpo/pulls) ⭐ 8,799 | 🐛 5 | 🌐 JavaScript | 📅 2025-07-21.
