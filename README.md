# Awesome WPO [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 446,124 | 🐛 83 | 📅 2026-03-09 with stars

[![GitHub contributors](https://img.shields.io/github/contributors/davidsonfellipe/awesome-wpo.svg)](https://github.com/davidsonfellipe/awesome-wpo/graphs/contributors) ⭐ 8,851 | 🐛 12 | 🌐 JavaScript | 📅 2026-03-12
...
* [Lighthouse](https://github.com/GoogleChrome/lighthouse) ⭐ 29,931 | 🐛 512 | 🌐 JavaScript | 📅 2026-03-16 - Auditing and performance metrics tool for Progressive Web Applications.
...
* [Grunt-perfbudget](https://github.com/tkadlec/grunt-perfbudget) ⭐ 851 | 🐛 20 | 🌐 JavaScript | 📅 2026-02-01 - A Grunt.js task for enforcing a performance budget ([more on performance budgets](https://timkadlec.com/2013/01/setting-a-performance-budget/)).
* [Grunt-yslow](https://github.com/andyshora/grunt-yslow) ⭐ 90 | 🐛 11 | 🌐 JavaScript | 📅 2017-04-17 - Grunt task for testing page performance using PhantomJS, a headless WebKit browser.
...
* [Webpack bundle analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) ⭐ 12,680 | 🐛 24 | 🌐 JavaScript | 📅 2026-03-02 - webpack plugin and CLI utility that represents bundle content as a convenient interactive zoomable treemap.
* [Bundlesize](https://github.com/siddharthkp/bundlesize) ⭐ 4,484 | 🐛 83 | 🌐 JavaScript | 📅 2025-01-15 - Keep your bundle size in check.
* [source-map-explorer](https://github.com/danvk/source-map-explorer) ⭐ 3,925 | 🐛 57 | 🌐 TypeScript | 📅 2023-03-14 - Analyze and debug bundle space usage through source maps.
...
* [BundleStats](https://github.com/relative-ci/bundle-stats) ⭐ 668 | 🐛 55 | 🌐 TypeScript | 📅 2026-03-17 - Generate bundle report(bundle size, assets, modules, packages) and compare the results between different builds
...
* [Stats.js](https://github.com/mrdoob/stats.js) ⭐ 9,102 | 🐛 22 | 🌐 JavaScript | 📅 2024-10-11 - This class provides a simple info box that will help you monitor your code performance.
...
* [PerfMap](https://github.com/zeman/perfmap) ⭐ 3,777 | 🐛 12 | 🌐 JavaScript | 📅 2017-05-12 - A bookmarklet to create a frontend performance heatmap of resources loaded in the browser using the Resource Timing API.
...
* [jsDelivr](https://github.com/jsdelivr/jsdelivr) ⭐ 6,182 | 🐛 74 | 🌐 JavaScript | 📅 2025-04-02 - Similar to Google Hosted Libraries, jsDelivr is an open-source CDN that allows developers to host their own projects and anyone to link to our hosted files on their sites.
...
* [Lighthouse](https://github.com/GoogleChrome/lighthouse) ⭐ 29,931 | 🐛 512 | 🌐 JavaScript | 📅 2026-03-16 - Audits Core Web Vitals in lab conditions (see [Analyzers](#analyzers)).
* [web-vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,446 | 🐛 20 | 🌐 JavaScript | 📅 2026-03-12 - Small library to accurately measure Core Web Vitals (LCP, FID, CLS, INP, TTFB) in the browser.
* [Lighthouse CI](https://github.com/GoogleChrome/lighthouse-ci) ⭐ 6,899 | 🐛 224 | 🌐 JavaScript | 📅 2026-02-22 - Run Lighthouse in CI to enforce Core Web Vitals budgets on every commit.
...
* [Sharp](https://github.com/lovell/sharp) ⭐ 32,021 | 🐛 118 | 🌐 JavaScript | 📅 2026-03-12 - The typical use case for this high-speed Node.js module is to convert large images of many formats to smaller, web-friendly JPEG, PNG, and WebP images of varying dimensions.
* [Exexif](https://github.com/h4cc/awesome-elixir) ⭐ 13,096 | 🐛 11 | 🌐 Elixir | 📅 2025-10-12 - Pure elixir library to extract tiff and exif metadata from JPEG files.
...
* [mozjpeg](https://github.com/mozilla/mozjpeg) ⭐ 5,669 | 🐛 99 | 🌐 C | 📅 2025-06-23 - Improved JPEG encoder.
...
* [lozad.js](https://github.com/ApoorvSaxena/lozad.js) ⭐ 7,505 | 🐛 69 | 🌐 JavaScript | 📅 2025-11-18 - Highly performant, light \~0.9kb, and configurable lazy loader in pure JS with no dependencies for responsive images, iframes, and more
...
* [InstantClick](https://github.com/dieulot/instantclick) ⭐ 5,504 | 🐛 55 | 🌐 JavaScript | 📅 2018-06-06 - InstantClick makes the following links in your site instant.
* [HeadJS](https://github.com/headjs/headjs) ⭐ 4,132 | 🐛 66 | 🌐 JavaScript | 📅 2023-04-20- The only script in your HEAD. for Responsive Design, Feature Detections, and Resource Loading.
...
* [UglifyJS2](https://github.com/mishoo/UglifyJS2) ⭐ 13,409 | 🐛 45 | 🌐 JavaScript | 📅 2024-11-22 - UglifyJS is a JavaScript parser, minifier, compressor or beautifier toolkit, written in JavaScript.
...
* [CSSO](https://github.com/css/csso) ⭐ 3,798 | 🐛 98 | 🌐 JavaScript | 📅 2024-06-21 - CSS minimizer unlike others. In addition to usual minification techniques, it can perform structural optimization of CSS files, resulting in smaller file size compared to other minifiers.
* [YUI Compressor](https://github.com/yui/yuicompressor) ⭐ 3,004 | 🐛 163 | 🌐 Java | 📅 2021-09-15 - JavaScript compressor which, in addition to removing comments and white-spaces, obfuscates local variables using the smallest possible variable name. This obfuscation is safe, even when using constructs such as 'eval' or 'with' (although the compression is not optimal is those cases) Compared to jsmin, the average savings is around 20%.
...
* [Lazysizes](https://github.com/aFarkas/lazysizes) ⭐ 17,739 | 🐛 209 | 🌐 JavaScript | 📅 2024-04-03 - High-performance lazy loader for images (responsive and normal), iframes, and scripts, that detects any visibility changes triggered through user interaction, CSS or JavaScript without configuration.
...
* [uCSS](https://github.com/oyvindeh/ucss) ⭐ 1,618 | 🐛 3 | 🌐 JavaScript | 📅 2017-01-26 - uCSS is made for crawling (large) sites to find unused CSS selectors, but not remove unused CSS.
...
* [SVGO](https://github.com/svg/svgo) ⭐ 22,386 | 🐛 254 | 🌐 JavaScript | 📅 2026-03-14 - SVGO is a Nodejs-based tool for optimizing SVG vector graphics files.
...
* [wrk](https://github.com/wg/wrk) ⭐ 40,137 | 🐛 203 | 🌐 C | 📅 2023-12-30 - A HTTP benchmarking tool (with optional Lua scripting for request generation, response
  processing, and custom reporting)
* [beeswithmachineguns](https://github.com/newsapps/beeswithmachineguns) ⭐ 6,618 | 🐛 77 | 🌐 Python | 📅 2024-03-28 - A utility for arming (creating) many bees (micro EC2 instances) to attack (load test) targets (web applications).
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 446,124 | 🐛 83 | 📅 2026-03-09.
...
For contributing, [open an issue](https://github.com/davidsonfellipe/awesome-wpo/issues) ⭐ 8,851 | 🐛 12 | 🌐 JavaScript | 📅 2026-03-12 and/or a [pull request](https://github.com/davidsonfellipe/awesome-wpo/pulls) ⭐ 8,851 | 🐛 12 | 🌐 JavaScript | 📅 2026-03-12.
