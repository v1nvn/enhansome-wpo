# Awesome WPO [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 438,983 | 🐛 70 | 📅 2026-01-28 with stars

[![GitHub contributors](https://img.shields.io/github/contributors/davidsonfellipe/awesome-wpo.svg)](https://github.com/davidsonfellipe/awesome-wpo/graphs/contributors) ⭐ 8,816 | 🐛 6 | 🌐 JavaScript | 📅 2025-07-21
...
* [Lighthouse](https://github.com/GoogleChrome/lighthouse) ⭐ 29,831 | 🐛 507 | 🌐 JavaScript | 📅 2026-02-20 - Auditing and performance metrics tool for Progressive Web Applications.
...
* [Webpack bundle analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) ⭐ 12,684 | 🐛 23 | 🌐 JavaScript | 📅 2026-02-20 - webpack plugin and CLI utility that represents bundle content as a convenient interactive zoomable treemap.
...
* [BundleStats](https://github.com/relative-ci/bundle-stats) ⭐ 667 | 🐛 57 | 🌐 TypeScript | 📅 2026-02-20 - Generate bundle report(bundle size, assets, modules, packages) and compare the results between different builds
...
* [Stats.js](https://github.com/mrdoob/stats.js) ⭐ 9,092 | 🐛 22 | 🌐 JavaScript | 📅 2024-10-11 - This class provides a simple info box that will help you monitor your code performance.
...
* [jsDelivr](https://github.com/jsdelivr/jsdelivr) ⭐ 6,157 | 🐛 74 | 🌐 JavaScript | 📅 2025-04-02 - Similar to Google Hosted Libraries, jsDelivr is an open-source CDN that allows developers to host their own projects and anyone to link to our hosted files on their sites.
...
* [Sharp](https://github.com/lovell/sharp) ⭐ 31,930 | 🐛 120 | 🌐 JavaScript | 📅 2026-02-01 - The typical use case for this high-speed Node.js module is to convert large images of many formats to smaller, web-friendly JPEG, PNG, and WebP images of varying dimensions.
* [Exexif](https://github.com/h4cc/awesome-elixir) ⭐ 13,085 | 🐛 10 | 🌐 Elixir | 📅 2025-10-12 - Pure elixir library to extract tiff and exif metadata from JPEG files.
...
* [ImageOptim-CLI](https://github.com/JamieMason/ImageOptim-CLI) ⭐ 3,520 | 🐛 9 | 🌐 TypeScript | 📅 2024-09-13 - Automates ImageOptim, ImageAlpha, and JPEGmini for Mac to make batch optimization of images part of your automated build process.
...
* [Jpegoptim](https://github.com/tjko/jpegoptim) ⭐ 1,764 | 🐛 12 | 🌐 C | 📅 2026-02-01 - Utility to optimize/compress JPEG files.
...
* [HeadJS](https://github.com/headjs/headjs) ⭐ 4,130 | 🐛 66 | 🌐 JavaScript | 📅 2023-04-20- The only script in your HEAD. for Responsive Design, Feature Detections, and Resource Loading.
...
* [Phantomas](https://github.com/macbre/phantomas) ⭐ 2,262 | 🐛 62 | 🌐 JavaScript | 📅 2026-02-05 - PhantomJS-based web performance metrics collector and monitoring tool.
...
* [HTMLMinifier](https://github.com/kangax/html-minifier) ⭐ 5,128 | 🐛 108 | 🌐 JavaScript | 📅 2025-07-19 - HTMLMinifier is a highly configurable, well-tested, Javascript-based HTML minifier, with lint-like capabilities.
...
* [Clean-css](https://github.com/jakubpawlowicz/clean-css) ⭐ 4,200 | 🐛 42 | 🌐 JavaScript | 📅 2024-10-18 - A fast, efficient, and well-tested CSS minifier for node.js.
...
* [CSSO](https://github.com/css/csso) ⭐ 3,798 | 🐛 104 | 🌐 JavaScript | 📅 2024-06-21 - CSS minimizer unlike others. In addition to usual minification techniques, it can perform structural optimization of CSS files, resulting in smaller file size compared to other minifiers.
* [YUI Compressor](https://github.com/yui/yuicompressor) ⭐ 3,006 | 🐛 163 | 🌐 Java | 📅 2021-09-15 - JavaScript compressor which, in addition to removing comments and white-spaces, obfuscates local variables using the smallest possible variable name. This obfuscation is safe, even when using constructs such as 'eval' or 'with' (although the compression is not optimal is those cases) Compared to jsmin, the average savings is around 20%.
...
* [Django-pipeline](https://github.com/cyberdelia/django-pipeline) ⭐ 1,544 | 🐛 155 | 🌐 Python | 📅 2026-01-05 - Pipeline is an asset packaging library for Django, providing both CSS and JavaScript concatenation and compression, built-in JavaScript template support, and optional data-URI image and font embedding.
...
* [SVGO](https://github.com/svg/svgo) ⭐ 22,326 | 🐛 260 | 🌐 JavaScript | 📅 2026-02-20 - SVGO is a Nodejs-based tool for optimizing SVG vector graphics files.
...
* [wrk](https://github.com/wg/wrk) ⭐ 40,070 | 🐛 202 | 🌐 C | 📅 2023-12-30 - A HTTP benchmarking tool (with optional Lua scripting for request generation, response
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 438,983 | 🐛 70 | 📅 2026-01-28.
* [bayandin/awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,231 | 🐛 43 | 🌐 Ruby | 📅 2024-06-02.
...
For contributing, [open an issue](https://github.com/davidsonfellipe/awesome-wpo/issues) ⭐ 8,816 | 🐛 6 | 🌐 JavaScript | 📅 2025-07-21 and/or a [pull request](https://github.com/davidsonfellipe/awesome-wpo/pulls) ⭐ 8,816 | 🐛 6 | 🌐 JavaScript | 📅 2025-07-21.
