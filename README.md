# Awesome WPO [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 445,097 | 🐛 77 | 📅 2026-03-09 with stars

[![GitHub contributors](https://img.shields.io/github/contributors/davidsonfellipe/awesome-wpo.svg)](https://github.com/davidsonfellipe/awesome-wpo/graphs/contributors) ⭐ 8,848 | 🐛 12 | 🌐 JavaScript | 📅 2026-03-12
...
* [Lighthouse](https://github.com/GoogleChrome/lighthouse) ⭐ 29,908 | 🐛 511 | 🌐 JavaScript | 📅 2026-03-11 - Auditing and performance metrics tool for Progressive Web Applications.
...
* [PSI](https://github.com/addyosmani/psi) ⭐ 3,111 | 🐛 15 | 🌐 JavaScript | 📅 2021-04-10 - PageSpeed Insights for Node.js - with reporting.
...
* [Stats.js](https://github.com/mrdoob/stats.js) ⭐ 9,100 | 🐛 22 | 🌐 JavaScript | 📅 2024-10-11 - This class provides a simple info box that will help you monitor your code performance.
...
* [Lighthouse](https://github.com/GoogleChrome/lighthouse) ⭐ 29,908 | 🐛 511 | 🌐 JavaScript | 📅 2026-03-11 - Audits Core Web Vitals in lab conditions (see [Analyzers](#analyzers)).
* [web-vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,442 | 🐛 19 | 🌐 JavaScript | 📅 2026-03-12 - Small library to accurately measure Core Web Vitals (LCP, FID, CLS, INP, TTFB) in the browser.
* [Lighthouse CI](https://github.com/GoogleChrome/lighthouse-ci) ⭐ 6,893 | 🐛 224 | 🌐 JavaScript | 📅 2026-02-22 - Run Lighthouse in CI to enforce Core Web Vitals budgets on every commit.
...
* [Sharp](https://github.com/lovell/sharp) ⭐ 32,008 | 🐛 118 | 🌐 JavaScript | 📅 2026-03-12 - The typical use case for this high-speed Node.js module is to convert large images of many formats to smaller, web-friendly JPEG, PNG, and WebP images of varying dimensions.
* [Exexif](https://github.com/h4cc/awesome-elixir) ⭐ 13,094 | 🐛 10 | 🌐 Elixir | 📅 2025-10-12 - Pure elixir library to extract tiff and exif metadata from JPEG files.
* [Gm](https://github.com/aheckmann/gm) ⭐ 6,979 | 🐛 368 | 🌐 JavaScript | 📅 2025-02-25 - GraphicsMagick and ImageMagick for Node.js.
...
* [Jpegoptim](https://github.com/tjko/jpegoptim) ⭐ 1,772 | 🐛 12 | 🌐 C | 📅 2026-03-01 - Utility to optimize/compress JPEG files.
...
* [Phantomas](https://github.com/macbre/phantomas) ⭐ 2,260 | 🐛 63 | 🌐 JavaScript | 📅 2026-03-06 - PhantomJS-based web performance metrics collector and monitoring tool.
...
* [Grunt-uncss](https://github.com/addyosmani/grunt-uncss) ⭐ 3,804 | 🐛 9 | 🌐 HTML | 📅 2023-07-18 - A grunt task for removing unused CSS from your projects.
...
* [Critical](https://github.com/addyosmani/critical) ⭐ 10,179 | 🐛 48 | 🌐 JavaScript | 📅 2026-01-24 - Extract & Inline Critical-path CSS in HTML pages (alpha).
...
* [SVGO](https://github.com/svg/svgo) ⭐ 22,378 | 🐛 257 | 🌐 JavaScript | 📅 2026-03-13 - SVGO is a Nodejs-based tool for optimizing SVG vector graphics files.
...
* [wrk](https://github.com/wg/wrk) ⭐ 40,130 | 🐛 203 | 🌐 C | 📅 2023-12-30 - A HTTP benchmarking tool (with optional Lua scripting for request generation, response
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 445,097 | 🐛 77 | 📅 2026-03-09.
* [bayandin/awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,288 | 🐛 45 | 🌐 Ruby | 📅 2024-06-02.
...
For contributing, [open an issue](https://github.com/davidsonfellipe/awesome-wpo/issues) ⭐ 8,848 | 🐛 12 | 🌐 JavaScript | 📅 2026-03-12 and/or a [pull request](https://github.com/davidsonfellipe/awesome-wpo/pulls) ⭐ 8,848 | 🐛 12 | 🌐 JavaScript | 📅 2026-03-12.
