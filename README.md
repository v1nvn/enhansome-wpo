# Awesome WPO [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 437,050 | 🐛 69 | 📅 2026-01-28 with stars

[![GitHub contributors](https://img.shields.io/github/contributors/davidsonfellipe/awesome-wpo.svg)](https://github.com/davidsonfellipe/awesome-wpo/graphs/contributors) ⭐ 8,806 | 🐛 5 | 🌐 JavaScript | 📅 2025-07-21
...
* [Lighthouse](https://github.com/GoogleChrome/lighthouse) ⭐ 29,797 | 🐛 505 | 🌐 JavaScript | 📅 2026-02-11 - Auditing and performance metrics tool for Progressive Web Applications.
...
* [source-map-explorer](https://github.com/danvk/source-map-explorer) ⭐ 3,926 | 🐛 57 | 🌐 TypeScript | 📅 2023-03-14 - Analyze and debug bundle space usage through source maps.
...
* [BundleStats](https://github.com/relative-ci/bundle-stats) ⭐ 667 | 🐛 58 | 🌐 TypeScript | 📅 2026-02-13 - Generate bundle report(bundle size, assets, modules, packages) and compare the results between different builds
...
* [Stats.js](https://github.com/mrdoob/stats.js) ⭐ 9,096 | 🐛 22 | 🌐 JavaScript | 📅 2024-10-11 - This class provides a simple info box that will help you monitor your code performance.
* [Memory-stats.js](https://github.com/paulirish/memory-stats.js) ⭐ 2,096 | 🐛 3 | 🌐 JavaScript | 📅 2015-07-03 - minimal monitor for JS Heap Size via performance memory.
...
* [PerfMap](https://github.com/zeman/perfmap) ⭐ 3,783 | 🐛 12 | 🌐 JavaScript | 📅 2017-05-12 - A bookmarklet to create a frontend performance heatmap of resources loaded in the browser using the Resource Timing API.
...
* [jsDelivr](https://github.com/jsdelivr/jsdelivr) ⭐ 6,150 | 🐛 73 | 🌐 JavaScript | 📅 2025-04-02 - Similar to Google Hosted Libraries, jsDelivr is an open-source CDN that allows developers to host their own projects and anyone to link to our hosted files on their sites.
...
* [Assetgraph-sprite](https://github.com/assetgraph/assetgraph-sprite) ⭐ 36 | 🐛 9 | 🌐 JavaScript | 📅 2026-02-07 - Assetgraph transform for auto-generating sprites based on the CSS dependency graph.
...
* [Sharp](https://github.com/lovell/sharp) ⭐ 31,897 | 🐛 118 | 🌐 JavaScript | 📅 2026-02-01 - The typical use case for this high-speed Node.js module is to convert large images of many formats to smaller, web-friendly JPEG, PNG, and WebP images of varying dimensions.
...
* [Optimizt](https://github.com/343dev/optimizt) ⭐ 157 | 🐛 0 | 🌐 JavaScript | 📅 2026-01-23 - CLI image optimization tool. It can compress PNG, JPEG, GIF and SVG lossy and lossless, and also create AVIF and WebP versions for raster images.
...
* [HeadJS](https://github.com/headjs/headjs) ⭐ 4,134 | 🐛 66 | 🌐 JavaScript | 📅 2023-04-20- The only script in your HEAD. for Responsive Design, Feature Detections, and Resource Loading.
...
* [HTMLMinifier](https://github.com/kangax/html-minifier) ⭐ 5,129 | 🐛 108 | 🌐 JavaScript | 📅 2025-07-19 - HTMLMinifier is a highly configurable, well-tested, Javascript-based HTML minifier, with lint-like capabilities.
...
* [UglifyJS2](https://github.com/mishoo/UglifyJS2) ⭐ 13,399 | 🐛 44 | 🌐 JavaScript | 📅 2024-11-22 - UglifyJS is a JavaScript parser, minifier, compressor or beautifier toolkit, written in JavaScript.
* [Clean-css](https://github.com/jakubpawlowicz/clean-css) ⭐ 4,204 | 🐛 42 | 🌐 JavaScript | 📅 2024-10-18 - A fast, efficient, and well-tested CSS minifier for node.js.
...
* [YUI Compressor](https://github.com/yui/yuicompressor) ⭐ 3,009 | 🐛 163 | 🌐 Java | 📅 2021-09-15 - JavaScript compressor which, in addition to removing comments and white-spaces, obfuscates local variables using the smallest possible variable name. This obfuscation is safe, even when using constructs such as 'eval' or 'with' (although the compression is not optimal is those cases) Compared to jsmin, the average savings is around 20%.
...
* [Polymer Bundler](https://github.com/Polymer/tools/tree/master/packages/bundler) ⭐ 436 | 🐛 839 | 🌐 TypeScript | 📅 2026-01-24 - Polymer-bundler is a library for packaging project assets for production to minimize network round-trips.
...
* [wrk](https://github.com/wg/wrk) ⭐ 40,058 | 🐛 202 | 🌐 C | 📅 2023-12-30 - A HTTP benchmarking tool (with optional Lua scripting for request generation, response
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 437,050 | 🐛 69 | 📅 2026-01-28.
...
For contributing, [open an issue](https://github.com/davidsonfellipe/awesome-wpo/issues) ⭐ 8,806 | 🐛 5 | 🌐 JavaScript | 📅 2025-07-21 and/or a [pull request](https://github.com/davidsonfellipe/awesome-wpo/pulls) ⭐ 8,806 | 🐛 5 | 🌐 JavaScript | 📅 2025-07-21.
